    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
                <form id="onload" class="card login-form inner-content" method="post" action="signup.php">
                    <div class="card-body">
                        <div class="title">
                            <h3>Sign-up</h3>
                        ...
                        <div class="input-head">
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                    <div class="form-group input-group">
                                        ...
                                        <input class="form-control" type="text" placeholder="Nickname" minlength="3"
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group input-group">
                                        ...
                                        <input class="form-control" type="email" placeholder="Email" minlength="5"
                            ...
                            <div class="form-group input-group">
                                ...
                                <input class="form-control" type="date" placeholder="Birthdate" required
                                       autocomplete="off">
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                    <div class="form-group input-group">
                                        ...
                                        <input class="form-control" type="password" placeholder="Password" minlength="8"
                        ...
                        <div class="or"><a href="signin.php"><span>Login</span></a>
                        </div>
                        </h4>
                    </div>
                </form>
