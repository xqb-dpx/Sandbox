...
<head>
    ...
    <title>Spark - Reset Password</title>
                ...
                <form id="onload" class="card login-form inner-content" method="post">
                    <div class="card-body">
                        <div class="title">
                            ...
                            <p>We send you a recovery email</p>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                <div class="form-group input-group">
                                    ...
                                    <input style="background-color: #ebdb8d" class="form-control" type="submit" value="<?='Send Time'?>"
                                           required>
                                </div>
                            </div>
                            <div class="col-lg-6 col-12">
                        ...
                        <div class="or"><span><a href="signin.php">Login</a></span></div>
                    </div>
                </form>
            </div>
        </div>
